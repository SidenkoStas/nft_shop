...
$(".dark").on('click', function (e) {
	...
	document.getElementById("logo_js").src = "static/img/logos/Logo_white.png";
	document.getElementById("logo_js_f").src = "static/img/logos/Logo_white.png";
...
$(".light").on('click', function (e) {
	...
	document.getElementById("logo_js").src = "static/img/logos/Logo.png";
	document.getElementById("logo_js_f").src = "static/img/logos/Logo.png";
});
